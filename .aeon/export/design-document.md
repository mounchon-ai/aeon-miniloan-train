...
| context.json | /design:overview | done | approved | aplus191 | 2026-09-03T05:17:39Z | — |
...
|---|---|---|---|---|
| DEC-001 | framework | จะเลือก framework/runtime อะไรสำหรับพัฒนาฝั่ง API ซึ่งต้องเป็นสถาปัตยกรรมแบบ domain-centric/layered และเปิดสัญญา API ที่ทดสอบได้แบบ stateless (REST/JSON) ให้ Web เรียกใช้? | .NET (C# / ASP.NET Core) | เลือกแล้ว รอลายเซ็น |
...
|---|---|---|---|
| .NET (C# / ASP.NET Core) | ⭐ | รองรับสถาปัตยกรรมแบบ domain-centric/layered โดยตรง และมี OpenAPI/Swagger ในตัว ทำให้สัญญา API ที่ทดสอบได้ตามที่ตัวเลขที่ต้องผ่านคือ NFR-miniloan-005 กำหนดไว้ทำได้โดยไม่ต้องเพิ่มเครื่องมือภายนอก | — |
| Node.js (TypeScript / NestJS) | — | — | เหมาะกับทีมที่ถนัด JavaScript/TypeScript และต้องการ deploy ที่เบา |
| Java (Spring Boot) | — | — | เหมาะกับองค์กรที่มี ecosystem enterprise Java อยู่แล้ว |

| หัวข้อ | รายละเอียด |
|---|---|
| สิ่งที่เลือก | .NET (C# / ASP.NET Core) |
| เหตุผล | เลือก .NET เพราะรองรับสถาปัตยกรรมแบบ domain-centric/layered ที่ตัวเลขที่ต้องผ่านคือ NFR-miniloan-004 กำหนดไว้โดยตรง และมี OpenAPI ในตัวเพื่อทำสัญญา API ที่ทดสอบได้ตามที่ตัวเลขที่ต้องผ่านคือ NFR-miniloan-005 ต้องการ |
| ผู้ตัดสิน | aplus191 |
